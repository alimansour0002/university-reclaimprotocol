...
const providers = [
  { name: "American University of Rome", providerId: '8a769077-53f8-4bbb-b75f-d2afe3eb6a42' },
  { name: "Innopolis University", providerId: '337a2461-0464-495d-8f2e-642eeb04db4d' },
  { name: "HUJI university", providerId: '70075b76-f0bb-4e19-938b-ef1656c7d8ee' },
];
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-8 mt-8 gap-4 bg-black">
      <div className="z-10 w-full flex flex-col gap-4 items-center justify-center font-mono text-sm">
        <h2 className="text-slate-300 text-sm lg:text-4xl md:text-3xl sm:text-xl xs:text-xs text-nowrap">Reclaim University Demo</h2>
        <h4 className="text-slate-400 text-sm lg:text-xl md:text-lg sm:text-lg xs:text-xs">Generate a ZKP (Cryptographic) proof telling that you are a student at a university</h4>
